...
#define MAX_ASSOCIATED_DATA_LENGTH	16 //32
#define MAX_MESSAGE_LENGTH			16 //32
...
int main()
{
	...
	printf("\nStart with code Elephant Kecchak\n");
...
int generate_test_vectors()
{
	...
	//	for (unsigned long long adlen = 0; adlen <= MAX_ASSOCIATED_DATA_LENGTH; adlen++) {
			...
			//printf("Nonce =%u ", nonce);

			//fprint_bstr(fp, "PT = ", msg);
			//printf("PT =%u ", msg);

			//fprint_bstr(fp, "AD = ", ad);
			//printf("AD =%u  ", ad);
