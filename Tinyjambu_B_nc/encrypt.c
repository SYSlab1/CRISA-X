...
#define NROUND1 128*5 //640
#define NROUND2 128*8 //1024

/*optimized state update function*/    
void state_update( unsigned int *state, const unsigned char *key, unsigned int number_of_steps)__attribute__((noinline))
{
        unsigned int i;
        ...
        for (i = 0; i < number_of_steps; i = i + 128)
        {
        	...
        	state_update_block( state[0],state[1],state[2],state[3],key[0]);

        	state_update_block( state[1],state[2],state[3],state[0],key[1]);

        	state_update_block( state[2],state[3],state[0],state[1],key[2]);

        	state_update_block( state[3],state[0],state[1],state[2],key[3]);


//        	     t1 = ROTOR(state[1],state[2],15,17);
//                 t2 = ROTOR(state[2],state[3],6,26);
//                 t3 = ROTOR(state[2],state[3],21,11);
//                t4 = ROTOR(state[2],state[3],27,5);
//                state[0] = XOR5 ( state[0],t1,NotAnd(t2,t3),t4,((unsigned int*)key)[0]);


//                t1 = ROTOR(state[2],state[3],15,17);
//                t2 = ROTOR(state[3],state[0],6,26);
//                t3 = ROTOR(state[3],state[0],21,11);
//                t4 = ROTOR(state[3],state[0],27,5);
//                state[1] = XOR5 (state[1] ,t1,NotAnd(t2,t3),t4,((unsigned int*)key)[1]);

//                t1 = ROTOR(state[3],state[0],15,17);
//                t2 = ROTOR(state[0],state[1],6,26);
//                t3 = ROTOR(state[0],state[1],21,11);
//                t4 = ROTOR(state[0],state[1],27,5);
//                state[2] = XOR5 (state[2] ,t1,NotAnd(t2,t3),t4,((unsigned int*)key)[2]);
//
//
//                t1 = ROTOR(state[0],state[1],15,17);
//                t2 = ROTOR(state[1],state[2],6,26);
//                t3 = ROTOR(state[1],state[2],21,11);
//                t4 = ROTOR(state[1],state[2],27,5);
//                state[3] = XOR5 (state[3] ,t1,NotAnd(t2,t3),t4,((unsigned int*)key)[3]);
