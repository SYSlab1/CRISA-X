...
//void P12_evluation( u32_2 x0, u32_2 x1,u32_2  x2, u32_2 x3, u32_2 x4)__attribute__((nonline)) {
...
int crypto_aead_encrypt(unsigned char* c, unsigned long long* clen,
                        ...
                        const unsigned char* k) __attribute__((nolone)){
  u32_2 K0, K1, N0, N1;
...
#else
  P12();
 //u32 startCount = xthal_get_ccount();
P6();
//u32 endCount = xthal_get_ccount();

//u32  diffCount = endCount - startCount;
