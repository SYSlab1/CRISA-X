...
void state_update( unsigned int *state, const unsigned char *key, unsigned int number_of_steps)__attribute__((noinline))
{
        ...
        {
        	    t1 = ROTORimd(state[1],state[2],15,17);
                t2 = ROTORimd(state[2],state[3],6,26);
                t3 = ROTORimd(state[2],state[3],21,11);
                t4 = ROTORimd(state[2],state[3],27,5);
                state[0] = XOR5 ( state[0],t1,NotAnd(t2,t3),t4,((unsigned int*)key)[0]);


                t1 = ROTORimd(state[2],state[3],15,17);
                t2 = ROTORimd(state[3],state[0],6,26);
                t3 = ROTORimd(state[3],state[0],21,11);
                t4 = ROTORimd(state[3],state[0],27,5);
                state[1] = XOR5 (state[1] ,t1,NotAnd(t2,t3),t4,((unsigned int*)key)[1]);

                t1 = ROTORimd(state[3],state[0],15,17);
                t2 = ROTORimd(state[0],state[1],6,26);
                t3 = ROTORimd(state[0],state[1],21,11);
                t4 = ROTORimd(state[0],state[1],27,5);
                state[2] = XOR5 (state[2] ,t1,NotAnd(t2,t3),t4,((unsigned int*)key)[2]);


                t1 = ROTORimd(state[0],state[1],15,17);
                t2 = ROTORimd(state[1],state[2],6,26);
                t3 = ROTORimd(state[1],state[2],21,11);
                t4 = ROTORimd(state[1],state[2],27,5);
