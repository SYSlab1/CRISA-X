...
#define REARRANGE_RKEY_0_TIE(x) ({			\
	SWAPMOVEt(x,x,55,9);     \
	SWAPMOVEt(x,x,0xf,12);   \
	SWAPMOVEt(x,x,33,18);    \
	SWAPMOVEt(x,x,0xff,24);  \
})

#define REARRANGE_RKEY_1_TIE(x) ({			\
	SWAPMOVE_TIE(x, x, 0x11111111, 3);		\
	SWAPMOVE_TIE(x, x, 0x03030303, 6);		\
	SWAPMOVE_TIE(x, x, 0x000f000f, 12);		\
	SWAPMOVE_TIE(x, x, 0x000000ff, 24);		\
})

#define REARRANGE_RKEY_2_TIE(x) ({			\
	SWAPMOVE_TIE(x, x, 0x0000aaaa, 15);		\
	SWAPMOVE_TIE(x, x, 0x00003333, 18);		\
	SWAPMOVE_TIE(x, x, 0x0000f0f0, 12);		\
	SWAPMOVE_TIE(x, x, 0x000000ff, 24);		\
})

#define REARRANGE_RKEY_3_TIE(x) ({			\
	SWAPMOVE_TIE(x, x, 0x0a0a0a0a, 3);		\
	SWAPMOVE_TIE(x, x, 0x00cc00cc, 6);		\
	SWAPMOVE_TIE(x, x, 0x0000f0f0, 12);		\
	SWAPMOVE_TIE(x, x, 0x000000ff, 24);		\
})
#define KEY_UPDATE(x)											\
...
#define KEY_UPDATE_TIE(x) XORROTimdgift(x,12,4,0x0f) | XORROTimdgift(x,2,14,0x0f)
#define KEY_TRIPLE_UPDATE_0_TIE(x) XORROTimdgift(x,12,4,0x0f) | XORROTimdgift(x,2,14,0x0f)
#define KEY_DOUBLE_UPDATE_1_TIE(x) XORROTimdgift(x,12,4,0x0f) | XORROTimdgift(x,2,14,0x0f)
#define KEY_TRIPLE_UPDATE_1_TIE(x) XORROTimdgift(x,12,4,0x0f) | XORROTimdgift(x,2,14,0x0f)
#define KEY_DOUBLE_UPDATE_2_TIE(x) XORROTimdgift(x,12,4,0x0f)
#define KEY_TRIPLE_UPDATE_2_TIE(x) XORROTimdgift(x,12,4,0x0f)
#define KEY_DOUBLE_UPDATE_3_TIE(x)	XORROTimdgift(x,12,4,0x0f) | XORROTimdgift(x,2,14,0x0f)
#define KEY_TRIPLE_UPDATE_3_TIE(x)	XORROTimdgift(x,12,4,0x0f) | XORROTimdgift(x,2,14,0x0f)
#define KEY_DOUBLE_UPDATE_4_TIE(x) XORROTimdgift(x,12,4,0x0f) | XORROTimdgift(x,2,14,0x0f)
#define KEY_TRIPLE_UPDATE_4_TIE(x)  XORROTimdgift(x,12,4,0x0f) | XORROTimdgift(x,2,14,0x0f)
